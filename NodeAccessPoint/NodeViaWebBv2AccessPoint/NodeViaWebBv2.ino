...
const String htmlTop = "<html style=\"text-align: center;\"><head>"
    "<meta name=\"viewport\" content=\"width=device-width, initial-scale=1\" /><link rel=\"stylesheet\" href=\"http://arlora.co.nf/projects/libs/squared/sq.min.css\"/></head>";
...
"<div class=\"sq-container-halfs sq-bg-gray1\">"
"<a href=\"LEDOff\">"
"<div class=\"sq-card-halfs sq-card-btn sq-bg-yellow2 sq-card-padding\">"
"<h1 class=\"sq-textcolor-white sq-undraggable\">ON</h1>"
"</div>"
"</a>"
"</div>"
"<div class=\"sq-container-halfs sq-bg-gray1\">"
"<a href=\"LEDOn\">"
"<div class=\"sq-card-halfs sq-card-btn sq-bg-blue3 sq-card-padding\">"
"<h1 class=\"sq-textcolor-white sq-undraggable\">OFF</h1>"
"</div>"
"</a>"
"</div>";
